...
?>
 ...
 <!--
<body>
<p align="center" class="style1">Animal Rescue System</p>
<p align="center">MENU </p>

<h3>USER</h3>
<a href="location.php">Click here to upload a case</a>
<h3>Rescuer</h3>
<a href="rescuer1.php">Rescuers</a>
    ...
    <div class="divPanel page-content">
        ...
        <div class="row-fluid">
                <div class="span12">
                    ...
                    <p class="fontForPage_1" align="center" >Animal Rescue System</p>
					<p class="fontForPage_2_1" align="center">MENU </p>
					<br><br><br><br>

					<h3 class="fontForPage_2" align="center">USER</h3>
					<p align="center"><a id="fontForPage_3" href="location.php">Click here to upload a case</a></p>
					<br><br>
					<h3 class="fontForPage_2" align="center">RESCUER</h3>
					<p align="center"><a id="fontForPage_5" href="rescuer2.php">Click here to check rescue cases</a></p>
					<br><br><br><br>
					<p align="center"><a id="fontForPage_4" href="index.php">Log Out</a></p>
